...
class PurchaseShip201ResponseData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ship", "agent", "transaction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "ship": (
                    Ship.from_dict(obj["ship"]) if obj.get("ship") is not None else None
                ),
                "agent": (
                ...
                "transaction": (
                    ShipyardTransaction.from_dict(obj["transaction"])
