...
class SupplyConstructionRequest(BaseModel):
    """
    ...
    trade_symbol: TradeSymbol = Field(
        description="The symbol of the good to supply.", alias="tradeSymbol"
    )
    units: Annotated[int, Field(strict=True, ge=1)] = Field(
        description="Amount of units to supply."
    )
    __properties: ClassVar[List[str]] = ["shipSymbol", "tradeSymbol", "units"]
