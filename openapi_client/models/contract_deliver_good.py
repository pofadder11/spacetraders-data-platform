...
class ContractDeliverGood(BaseModel):
    ...
    trade_symbol: Annotated[str, Field(min_length=1, strict=True)] = Field(
        description="The symbol of the trade good to deliver.", alias="tradeSymbol"
    )
    destination_symbol: Annotated[str, Field(min_length=1, strict=True)] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "destinationSymbol": obj.get("destinationSymbol"),
                "unitsRequired": obj.get("unitsRequired"),
                "unitsFulfilled": obj.get("unitsFulfilled"),
            }
        )
        return _obj
