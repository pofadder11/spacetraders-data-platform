...
class SupplyConstruction201ResponseData(BaseModel):
    """
    ...
    cargo: ShipCargo
    __properties: ClassVar[List[str]] = ["construction", "cargo"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of construction
        if self.construction:
            _dict["construction"] = self.construction.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "construction": (
                    Construction.from_dict(obj["construction"])
                    if obj.get("construction") is not None
                    else None
                ),
                "cargo": (
