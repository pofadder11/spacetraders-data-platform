...
class GetMyFactions200ResponseDataInner(BaseModel):
    """
    GetMyFactions200ResponseDataInner
    """  # noqa: E501

    symbol: StrictStr
    reputation: StrictInt
    __properties: ClassVar[List[str]] = ["symbol", "reputation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"symbol": obj.get("symbol"), "reputation": obj.get("reputation")}
        )
        return _obj
