...
class CreateShipWaypointScan201ResponseData(BaseModel):
    """
    CreateShipWaypointScan201ResponseData
    """  # noqa: E501

    cooldown: Cooldown
    waypoints: List[ScannedWaypoint] = Field(description="List of scanned waypoints.")
    __properties: ClassVar[List[str]] = ["cooldown", "waypoints"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "waypoints": (
                    [ScannedWaypoint.from_dict(_item) for _item in obj["waypoints"]]
