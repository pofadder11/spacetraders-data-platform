...
class ShipRefine201ResponseDataProducedInner(BaseModel):
    """
    ShipRefine201ResponseDataProducedInner
    """  # noqa: E501

    trade_symbol: TradeSymbol = Field(
        description="Symbol of the good.", alias="tradeSymbol"
    )
    units: StrictInt = Field(description="Amount of units of the good.")
    __properties: ClassVar[List[str]] = ["tradeSymbol", "units"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"tradeSymbol": obj.get("tradeSymbol"), "units": obj.get("units")}
        )
        return _obj
