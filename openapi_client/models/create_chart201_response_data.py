...
class CreateChart201ResponseData(BaseModel):
    """
    ...
    agent: Agent
    __properties: ClassVar[List[str]] = ["chart", "waypoint", "transaction", "agent"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "waypoint": (
                    Waypoint.from_dict(obj["waypoint"])
                    if obj.get("waypoint") is not None
                    else None
                ),
                "transaction": (
                    ChartTransaction.from_dict(obj["transaction"])
