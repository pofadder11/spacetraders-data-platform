...
class ConstructionMaterial(BaseModel):
    ...
    required: StrictInt = Field(description="The number of units required.")
    fulfilled: StrictInt = Field(
        description="The number of units fulfilled toward the required amount."
    )
    __properties: ClassVar[List[str]] = ["tradeSymbol", "required", "fulfilled"]
