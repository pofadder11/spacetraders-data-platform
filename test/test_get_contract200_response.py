...
class TestGetContract200Response(unittest.TestCase):
    """GetContract200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetContract200Response:
        """Test GetContract200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetContract200Response`
        """
        model = GetContract200Response()
        if include_optional:
            return GetContract200Response(
                data = openapi_client.models.contract.Contract(
                    id = '0', 
                    faction_symbol = '0', 
                    type = 'PROCUREMENT', 
    ...
    def testGetContract200Response(self):
        """Test GetContract200Response"""
