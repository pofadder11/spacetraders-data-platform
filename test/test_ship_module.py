...
class TestShipModule(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShipModule:
        """Test ShipModule
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ShipModule`
        """
        model = ShipModule()
        if include_optional:
            return ShipModule(
