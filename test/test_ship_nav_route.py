...
class TestShipNavRoute(unittest.TestCase):
    """ShipNavRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShipNavRoute:
        """Test ShipNavRoute
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ShipNavRoute`
        """
        model = ShipNavRoute()
        if include_optional:
            return ShipNavRoute(
