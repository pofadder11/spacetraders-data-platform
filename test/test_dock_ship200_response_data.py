...
class TestDockShip200ResponseData(unittest.TestCase):
    """DockShip200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DockShip200ResponseData:
        """Test DockShip200ResponseData
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DockShip200ResponseData`
        """
        model = DockShip200ResponseData()
        if include_optional:
    ...
    def testDockShip200ResponseData(self):
        """Test DockShip200ResponseData"""
