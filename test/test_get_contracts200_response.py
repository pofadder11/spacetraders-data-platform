...
class TestGetContracts200Response(unittest.TestCase):
    """GetContracts200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetContracts200Response:
        """Test GetContracts200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetContracts200Response`
        """
        model = GetContracts200Response()
        if include_optional:
            return GetContracts200Response(
                data = [
                    openapi_client.models.contract.Contract(
                        id = '0', 
                        faction_symbol = '0', 
                        type = 'PROCUREMENT', 
    ...
    def testGetContracts200Response(self):
        """Test GetContracts200Response"""
